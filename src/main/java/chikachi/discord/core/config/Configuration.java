...
public class Configuration {
    ...
    private static Gson createGson() {
        return new GsonBuilder().registerTypeAdapter(ChannelConfigType.class, new ChannelConfigTypeAdapter())
                ...
                .registerTypeAdapter(Pattern.class, new PatternAdapter()).setVersion(3.0).setPrettyPrinting().create();
    }
