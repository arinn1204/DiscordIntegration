...
public class CoreUtils {
    ...
    public static void addPatterns() {
        ...
        Patterns.addMinecraftFormattingUnifyPattern(
                Patterns.fakeMinecraftCodePattern,
                new Patterns.ReplacementCallback() {
                    ...
                    public String replace(ArrayList<String> groups) {
                        MinecraftFormattingCodes minecraftFormattingCode = MinecraftFormattingCodes
                                .getByCode(groups.get(1).charAt(0));
        ...
        Patterns.addDiscordToMinecraftFormattingPattern(
                Pattern.compile("(?i)(\\*\\*|\\*|__|_|~~|`|```)"),
                new Patterns.ReplacementCallback() {
                    ...
                    public String replace(ArrayList<String> groups) {
                        ...
                        switch (modifier) {
                            ...
                            case "__":
                                ...
                                modifier = this.underline ? MinecraftFormattingCodes.UNDERLINE.toString()
                                        : resetString();
                                break;
                            case "~~":
                                this.strikethrough = !this.strikethrough;
                                modifier = this.strikethrough ? MinecraftFormattingCodes.STRIKETHROUGH.toString()
                                        : resetString();
                                break;
                        }
                    ...
                    public String post(String text) {
                        ...
                        text = Pattern.compile("(?i)\u00a7r(\u00a7([0-9A-FK-OR]))+\u00a7r").matcher(text)
                                .replaceAll(MinecraftFormattingCodes.RESET.toString());
                        return text;
                    }
                });

        Patterns.addMinecraftToDiscordFormattingPattern(
                Patterns.minecraftCodePattern,
                new Patterns.ReplacementCallback() {
