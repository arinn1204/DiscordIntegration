...
public class DiscordCommandSender extends FakePlayer {
    ...
    private static final ScheduledExecutorService executor = Executors.newSingleThreadScheduledExecutor(
            new ThreadFactoryBuilder().setNameFormat(DiscordCommandSender.class.getSimpleName()).setDaemon(true)
                    .build());
    ...
    private static String textComponentToDiscordMessage(IChatComponent component) {
        return Patterns.minecraftCodePattern.matcher(component.getUnformattedText()).replaceAll("");
    }
