...
public class TextFormatterTest {
    ...
    public void canBeConstructedWithArguments() {
        ...
        String result = new TextFormatter(hm).addArgument("USER", "testee").format(testString);
    ...
    public void textShouldBeReplacedCorrectly() {
        ...
        String result = new TextFormatter().addArgument("TEST", "success").format(testString);
        assertEquals("test success {USER}", result);

        result = new TextFormatter().addArgument("USER", "testee").format(testString);
        assertEquals("test {TEST} testee", result);

        result = new TextFormatter().addArgument("TEST", "success").addArgument("USER", "testee").format(testString);
        assertEquals("test success testee", result);
    }
