...
public class ChannelConfigTypeAdapter
        implements JsonSerializer<ChannelConfigType>, JsonDeserializer<ChannelConfigType> {
    ...
    @Override
    public ChannelConfigType deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
