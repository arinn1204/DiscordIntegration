...
public class DimensionConfigTypeAdapter
        implements JsonSerializer<DimensionConfigType>, JsonDeserializer<DimensionConfigType> {
    ...
    @Override
    public DimensionConfigType deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
