...
public class MinecraftListener {
    ...
    public void onCommand(CommandEvent event) {
        ...
        log.info("User {} is executing command {}", event.sender.getCommandSenderName(), event.command);
        ...
        if (commandName.equalsIgnoreCase("say") || commandName.equalsIgnoreCase("me")) {
            ...
            if (sender != null && Configuration.getConfig().minecraft.dimensions.generic.ignoreFakePlayerChat
            ...
            if (sender != null) {
                ...
                if (entity != null) {
                    MinecraftDimensionConfig dimensionConfig = minecraftConfig.dimensions
                    ...
                    channels = dimensionConfig.relayChat.getChannels(
                            genericConfig.relayChat.getChannels(
                                    dimensionConfig.discordChannel.getChannels(genericConfig.discordChannel)));
                } else {
            ...
            if (sender != null) {
                ...
                if (sender instanceof EntityPlayer) {
                    ...
                    Long discordId = Configuration.getLinking()
                            .getDiscordId(((EntityPlayer) sender).getGameProfile().getId());
                    if (discordId != null) {
            ...
            DiscordClient.getInstance().broadcast(
                    new Message().setAuthor(authorName).setAvatarUrl(avatarUrl).setMessage(messageConfig)
                            .setArguments(arguments).setPrefix(prefix),
                    channels);
        ...
        if (sender != null) {
            ...
            if (entity != null) {
                ...
                channels = dimensionConfig.relayCommands.getChannels(
                        genericConfig.relayCommands
                                .getChannels(dimensionConfig.discordChannel.getChannels(genericConfig.discordChannel)));
            } else {
        ...
        DiscordClient.getInstance().broadcast(
                new Message().setAuthor(authorName).setAvatarUrl(avatarUrl).setMessage(messageConfig)
                        .setArguments(arguments).setParsing(false),
                channels);
    }
    ...
    public void onChatMessage(ServerChatEvent event) {
        ...
        if (Configuration.getConfig().minecraft.dimensions.generic.ignoreFakePlayerChat
        ...
        MessageConfig messageConfig = dimensionConfig.messages.chatMessage != null
                ? dimensionConfig.messages.chatMessage
        ...
        DiscordClient.getInstance().broadcast(
                new Message().setAuthor(authorName).setAvatarUrl(avatarUrl).setMessage(messageConfig)
                        .setArguments(arguments).setPrefix(
                                dimensionConfig.chatPrefix != null && dimensionConfig.chatPrefix.trim().length() > 0
                                        ? dimensionConfig.chatPrefix
                                        : genericConfig.chatPrefix),
    ...
    public void onPlayerAchievement(AchievementEvent event) {
        ...
        if (entityPlayer != null && entityPlayer instanceof EntityPlayerMP) {
            ...
            arguments.put(
                    "DESCRIPTION",
                    StatCollector.translateToLocalFormatted(achievement.achievementDescription, "KEY"));

            MinecraftConfig minecraftConfig = Configuration.getConfig().minecraft;
            MinecraftDimensionConfig dimensionConfig = minecraftConfig.dimensions.getDimension(entityPlayer.dimension);
            MinecraftDimensionConfig genericConfig = minecraftConfig.dimensions.generic;

            MessageConfig messageConfig = dimensionConfig.messages.achievement != null
                    ? dimensionConfig.messages.achievement
    ...
    public void onPlayerJoin(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        MessageConfig messageConfig = dimensionConfig.messages.playerJoin != null ? dimensionConfig.messages.playerJoin
    ...
    public void onPlayerLeave(PlayerEvent.PlayerLoggedOutEvent event) {
        ...
        MessageConfig messageConfig = dimensionConfig.messages.playerLeave != null
                ? dimensionConfig.messages.playerLeave
    ...
    public void onPlayerDeath(LivingDeathEvent event) {
        ...
        if (entityLiving instanceof EntityPlayer) {
            ...
            arguments.put(
                    "REASON",
                    entityPlayer.func_110142_aN().func_151521_b().getUnformattedText()
                            .replace(entityPlayer.getDisplayName(), "").trim());

            MinecraftConfig minecraftConfig = Configuration.getConfig().minecraft;
            MinecraftDimensionConfig dimensionConfig = minecraftConfig.dimensions.getDimension(entityLiving.dimension);
            MinecraftDimensionConfig genericConfig = minecraftConfig.dimensions.generic;

            MessageConfig messageConfig = dimensionConfig.messages.playerDeath != null
                    ? dimensionConfig.messages.playerDeath
